        ...
        <main>
            <section className="relative h-full w-full px-[60px]">
                ...
                <div className="relative flex flex-col md:flex-row items-center justify-between py-20 max-w-8xl mx-auto px-4 md:px-12 gap-10">
                    ...
                    <div className="flex-1 flex flex-col justify-center items-center text-white max-w-2xl">
                        ...
                        <h1 className="text-5xl md:text-6xl font-600 mb-6 leading-tight text-center">Auto-Accident & Personal-Injury Urgent Care Book Same-Day</h1>
            ...
            <section className='grid grid-cols-2 gap-14 h-full px-[60px] py-20'>
                ...
                <div className=' flex items-start justify-center py-14 space-y-6 flex-col'>
                    <p className='text-6xl font-600'>Florida's 14-Day PIP Rule  See a Doctor Fast to Protect Your Claim</p>
            ...
            <section className="relative w-full py-52 flex items-center justify-center ">
                ...
                <div className="flex flex-col items-center justify-center h-full text-center self-center w-[50%]">
                    <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">Car-Accident Injury Care  Palm Beach County, FL</h1>
            ...
            <section className="w-full bg-[#FAFAFA] py-20 px-4 md:px-[60px]">
                <h2 className="text-5xl md:text-6xl font-bold text-center mb-6">Pain & Injuries We Treat After Accidents –<br />Palm Beach</h2>
                <div className="text-lg text-[#494647] text-center mb-12">Seen in less then 15 min for whiplash, nerve pain, headaches, or joint injuries—on-site X-ray, MRI, and direct PIP billing.</div>
