...
export const metadata = {
  ...
  keywords: [
    ...
    'urgent care $89 visit Palm Beach County',
...
export const pricingData = [
  ...
  },
  {
    title: 'X Ray',
    subtitle: 'Diagnostic Imaging',
    description: 'Walk-in X-ray for accident injuries, fractures, and broken bones. Get immediate imaging after a car accident, slip and fall, or work injury. We provide documentation for insurance or legal claims.',
    features: [
    ...
    priceNote: '/ one time payment',
    icon: <Polestar />,
    whatItIs: "X-ray imaging is a fundamental diagnostic tool for identifying injuries after car accidents, falls, or work incidents. Our urgent care centers provide immediate digital X-ray to assess for broken bones, hairline fractures, and spinal alignment after trauma. We specialize in accident-related imaging and provide documentation for insurance or legal claims.",
    symptomsTreated: "X-ray imaging can evaluate pain, swelling, or suspected fractures after an accident. We assess for broken bones, dislocations, and other injuries from car crashes, falls, or workplace incidents.",
    conditionsAddressed: "X-ray imaging can diagnose fractures, dislocations, and other injuries after car accidents, slip and falls, or work injuries. We also use X-rays for procedural guidance and to assess spinal alignment after trauma.",
    treatmentProcess: "The X-ray process begins with a history and exam focused on the injury event. Our technicians capture digital images of the affected area, and our providers interpret results immediately. We provide documentation for your PI or insurance claim.",
    urgentCareAdvantage: "Our urgent care centers provide walk-in X-ray for accident injuries and fractures, with immediate results and documentation for insurance or legal claims. No appointment needed—just walk in after your accident.",
    costAdvantage: "X-ray services at our urgent care centers offer significant cost savings compared to hospital-based X-ray services, with typical costs of $70.00 compared to $200-400 at hospitals. Our transparent pricing includes the examination, interpretation, and immediate results, with no additional facility fees or hidden charges. We accept most major insurance plans with lower copays and deductibles compared to hospital settings, and we offer affordable self-pay options for patients without insurance. The immediate availability and faster turnaround times mean patients can avoid taking time off work or arranging childcare for extended hospital visits.",
    slug: 'x-ray',
    img: '/x-ray.png',
  ...
  },
  {
    ...
    description: 'Advanced cross-sectional imaging for trauma, chest pain, and abdominal emergencies with immediate results.',
    features: [
      'Fast, low-dose cross-sectional imaging',
      'Ideal for trauma and emergency evaluation',
      'Immediate results for urgent cases',
    ],
    price: '$200.00',
    priceNote: '/ one time payment',
    icon: <Polestar />,
    ...
    symptomsTreated: "CT scanning can evaluate symptoms including trauma, chest pain, abdominal pain, shortness of breath, neurological symptoms, and various other acute medical symptoms. We use CT to assess conditions such as internal bleeding, organ damage, fractures, pulmonary embolism, appendicitis, kidney stones, and many other medical concerns. CT is particularly valuable for evaluating trauma patients, emergency cases, and complex medical conditions that require immediate diagnostic information. The comprehensive nature of CT imaging provides essential diagnostic information for many urgent medical conditions.",
    conditionsAddressed: "CT scanning can diagnose and evaluate numerous medical conditions including trauma, internal bleeding, organ damage, fractures, pulmonary embolism, appendicitis, kidney stones, tumors, cardiovascular conditions, and various other acute and chronic medical conditions. We also use CT for cancer staging, treatment planning, and monitoring treatment response. The versatility and detailed imaging capabilities of CT technology make it an essential diagnostic tool for evaluating a wide range of medical conditions in our urgent care setting, particularly for trauma and emergency cases.",
    treatmentProcess: "The CT scanning process begins with a comprehensive patient history and physical examination to determine the most appropriate imaging approach. Our trained CT technicians position the patient and use specialized equipment to capture detailed images of the area of interest. The examination typically takes 15-30 minutes, depending on the complexity of the study and the areas being evaluated. CT images are processed and reviewed by our board-certified radiologists, who provide detailed interpretations and treatment recommendations. Results are typically available within hours, allowing for prompt treatment planning.",
    urgentCareAdvantage: "Our urgent care centers provide immediate access to CT imaging without the lengthy appointment scheduling typically associated with hospital-based CT services. We can perform CT examinations that provide detailed diagnostic information, allowing for comprehensive treatment planning. Our multi-slice CT technology provides exceptional image quality and detailed diagnostic information, ensuring accurate diagnosis and treatment recommendations. The immediate availability of CT technology in our urgent care setting ensures that patients with trauma or emergency conditions can receive prompt evaluation and treatment.",
  ...
  {
    title: 'Nuclear Scans',
    subtitle: 'Nuclear Medicine Imaging',
    description: 'Advanced functional imaging for thyroid, bone, and cardiac evaluations using radioactive tracers.',
    features: [
      'Functional imaging for organ evaluation',
      'Advanced diagnostic for complex conditions',
      'Same-day results for urgent cases',
    ],
    price: '$550.00',
    priceNote: '/ one time payment',
    icon: <Polestar />,
    whatItIs: "Nuclear medicine represents the cutting edge of functional imaging technology, utilizing small amounts of radioactive materials called tracers to evaluate organ function and detect diseases at the cellular level. Unlike traditional imaging modalities that primarily show anatomical structure, nuclear medicine provides functional information that can reveal disease processes at their earliest stages, often before symptoms develop or structural changes occur. Our nuclear medicine suite features state-of-the-art gamma cameras and PET-CT technology that can detect metabolic changes, blood flow patterns, and cellular activity long before structural changes become apparent on other imaging studies. Nuclear medicine is particularly valuable for evaluating thyroid function, detecting bone metastases, assessing cardiac perfusion, identifying inflammatory processes, and diagnosing a wide range of oncological and neurological conditions.",
    symptomsTreated: "Nuclear medicine can evaluate symptoms including thyroid problems, bone pain, cardiac symptoms, neurological symptoms, and various other acute and chronic medical symptoms. We use nuclear medicine to assess conditions such as thyroid disorders, bone metastases, cardiac perfusion problems, inflammatory processes, and many other medical concerns. Nuclear medicine is particularly valuable for evaluating functional problems, metabolic disorders, and complex medical conditions that require detailed functional assessment. The comprehensive nature of nuclear medicine imaging provides essential diagnostic information for many medical conditions.",
    conditionsAddressed: "Nuclear medicine can diagnose and evaluate numerous medical conditions including thyroid disorders, bone metastases, cardiac perfusion problems, inflammatory processes, oncological conditions, neurological disorders, and various other acute and chronic medical conditions. We also use nuclear medicine for cancer staging, treatment planning, and monitoring treatment response. The versatility and detailed functional imaging capabilities of nuclear medicine technology make it an essential diagnostic tool for evaluating a wide range of medical conditions in our urgent care setting, particularly for complex functional and metabolic conditions.",
    treatmentProcess: "The nuclear medicine examination process begins with a comprehensive patient history and physical examination to determine the most appropriate imaging approach. Our trained nuclear medicine technicians administer the appropriate radioactive tracer and use specialized equipment to capture detailed functional images of the area of interest. The examination typically takes 30-60 minutes, depending on the complexity of the study and the areas being evaluated. Nuclear medicine images are processed and reviewed by our board-certified nuclear medicine specialists, who provide detailed interpretations and treatment recommendations. Results are typically available within hours, allowing for prompt treatment planning.",
    urgentCareAdvantage: "Our urgent care centers provide immediate access to nuclear medicine imaging without the lengthy appointment scheduling typically associated with hospital-based nuclear medicine services. We can perform nuclear medicine examinations that provide detailed functional diagnostic information, allowing for comprehensive treatment planning. Our nuclear medicine technology provides exceptional functional image quality and detailed diagnostic information, ensuring accurate diagnosis and treatment recommendations. The immediate availability of nuclear medicine technology in our urgent care setting ensures that patients with complex functional conditions can receive prompt evaluation and treatment.",
    costAdvantage: "Nuclear medicine services at our urgent care centers offer significant cost savings compared to hospital-based nuclear medicine services, with typical costs of $550.00 compared to $1,500-3,000 at hospitals. Our transparent pricing includes the examination, interpretation, and detailed results, with no additional facility fees or hidden charges. We accept most major insurance plans with lower copays and deductibles compared to hospital settings, and we offer affordable self-pay options for patients without insurance. The immediate availability and faster turnaround times mean patients can avoid taking time off work or arranging childcare for extended hospital visits.",
    slug: "nuclear-scans",
    img: '/nuclear2.png',
  ...
  },
  {
    ...
    costAdvantage: "MRI services at our urgent care centers offer significant cost savings compared to hospital-based MRI services, with typical costs of $300.00 compared to $1,200-2,500 at hospitals. Our transparent pricing includes the examination, interpretation, and detailed results, with no additional facility fees or hidden charges. We accept most major insurance plans with lower copays and deductibles compared to hospital settings, and we offer affordable self-pay options for patients without insurance. The immediate availability and faster turnaround times mean patients can avoid taking time off work or arranging childcare for extended hospital visits.",
    slug: "mri",
    img: '/mri.png',
