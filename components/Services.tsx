...
export const services = [
  ...
  },
  {
    ...
    howItWorks: "The digital X-ray process begins when a controlled beam of X-rays is directed through the patient's body toward a specialized electronic detector panel. As the X-rays pass through the body, different tissues absorb the radiation to varying degrees - dense structures like bones absorb more X-rays and appear white on the resulting image, while soft tissues like muscles and organs absorb fewer X-rays and appear in various shades of gray. The electronic detector panel, which contains thousands of tiny sensors, captures the X-ray energy and converts it directly into digital signals. These signals are then processed by sophisticated computer algorithms that create high-resolution digital images in real-time, allowing healthcare providers to manipulate the images by adjusting contrast, brightness, and magnification to optimize visualization of specific areas of interest. Additionally, digital X-ray images can be easily stored, transmitted, and shared with other healthcare providers, facilitating collaboration and ensuring that patients receive the most appropriate care based on their imaging results.",
