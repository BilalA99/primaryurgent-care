  ...
  return (
    <section className="py-20 xl:px-[60px] px-6">
      <div className="max-w-8xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 my-10 pb-20">
