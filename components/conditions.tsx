...
export const conditions: ConditionInfoProp[] = [
    ...
    },
    {
        ...
        treatment: "Treatment typically includes the RICE protocol (Rest, Ice, Compression, Elevation), pain management, and immobilization when necessary. Our providers can apply appropriate braces or splints and provide prescription medications if needed. We can also arrange specialist referrals for rehabilitation.",
    ...
    },
    {
        ...
        treatment: "Treatment depends on the specific injury and may include rest, medications, or referral to sports medicine specialists. Our providers can provide appropriate treatment and rehabilitation guidance. We can also arrange referrals to specialists for complex injuries.",
