    ...
    return (
        <div className={`bg-[#D52128] rounded-lg shadow-md p-8 flex flex-col justify-between items-center hover:cursor-pointer group ${height} text-white`}>
            ...
            <div className='flex flex-col justify-center items-start'>
                ...
                <a href="tel:5612310250" className="w-full bg-white text-gray-800 font-bold py-3 px-4 rounded-lg flex items-center justify-center space-x-2">
                    <div className='group-hover:-translate-x-2 transition-transform duration-300'><Phone /></div>
                    <span className='text-[#D52128] font-[500] '> (561) 231-0250</span>
                </a>
            </div>
        </div>
    );
