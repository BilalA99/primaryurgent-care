...
export const PainCareWeTreatData : PainCareWeTreatData[] = [
    {
        ...
        treatment: "Treatment for whiplash and neck pain includes physical examination, X-rays or MRI, pain management, muscle relaxants, and specialist referrals. Our urgent care providers ensure you receive the right care and documentation for your case.",
    ...
    },
    {
        ...
        treatment: "Treatment includes physical examination, X-rays or MRI, pain management, muscle relaxants, and specialist referrals. We provide immediate stabilization and ensure proper documentation for your PI case.",
        ...
        <section className="w-full bg-[#FAFAFA] py-20 px-4 md:px-[60px]">
            ...
            <Reveal className='w-full overflow-hidden'>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-2 max-w-5xl mx-auto">
                    <Link href="/car-accident/whiplash" className="bg-white hover:scale-105 transition-all duration-300 rounded-2xl p-10 flex flex-col items-start justify-between h-60 shadow-sm">
                        <NeckPain />
                        <div className="text-2xl font-bold text-black mt-6">Neck Pain</div>
                    </Link>
                    <Link href="/car-accident/back-neck-pain" className="bg-white hover:scale-105 transition-all duration-300  rounded-2xl p-10 flex flex-col items-start justify-between h-60 shadow-sm">
                        <BackPain />
                        <div className="text-2xl font-bold text-black mt-6">Back Pain</div>
                    </Link>
                    <Link href="/urgent-injury-care/hand-pain" className="bg-white hover:scale-105 transition-all duration-300 rounded-2xl p-10 flex flex-col items-start justify-between h-60 shadow-sm">
                        <HandPain />
                        <div className="text-2xl font-bold text-black mt-6">Hand Pain</div>
                    </Link>
                    <Link href="/urgent-injury-care/shoulder-pain" className="bg-white hover:scale-105 transition-all duration-300 rounded-2xl p-10 flex flex-col items-start justify-between h-60 shadow-sm">
                        <ShoulderPain />
                        <div className="text-2xl font-bold text-black mt-6">Shoulder Pain</div>
                    </Link>
                    <Link href='/urgent-injury-care/knee-foot-pain' className="bg-white hover:scale-105 transition-all duration-300 rounded-2xl p-10 flex flex-col items-start justify-between h-60 shadow-sm">
                        <KneePain />
                        <div className="text-2xl font-bold text-black mt-6">Knee & Foot Pain</div>
                    </Link>
                    <Link href='/urgent-injury-care/headaches-migraines' className="bg-white hover:scale-105 transition-all duration-300  rounded-2xl p-10 flex flex-col items-start justify-between h-60 shadow-sm">
                        <Headaches />
